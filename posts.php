...
$randomNumber=getRandomPostCount(3,25); // 3-25 arasında random olarak bir sayı üretilecek
$getPosts=getLatestPosts($randomNumber); //elde edilen random sayıyı getLatestPosts() fonksiyonuna parametre olarak gönderdik
